...
public class Student {
    ...
    //It can be used just inside the package it as created
    double stdGpa = 3.83;//If you do not type any access modifier it will be "default"

    //It can be used inside the "day20accessmodifiersinheritance" package, and from the child classes
    //in other packages.
    protected String stdAddress = "Miami, FL USA";

    //Following ones are "static", to access static things
    //do not use "object", use class name.
 ...
 1) What is the difference between "default" and "protected" access modifiers?
       i) "protected" access modifier is wider than "default".
       ii) "default" ones cannot be used from outside the package,
       therefore it's other name is "package private"
       "protected" ones can be used from the class in other packages
       if the classes are "child classes"

 2) Could you please tell the name of the access modifiers from
