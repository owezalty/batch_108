package day24interfaces;
    ...
    /**
       ...
       2) All methods in an interface are "public" and "abstract" as default.
        Because of that; even you don't declare the methods
     "public" and "abstract", they will be "public" and "abstract"/
     "public abstract void digital();" and "void digital" are same
        3) If "parent interfaces" have methods with the same name,
     overriding just one of them is enough.
        4)"Parent interfaces" cannot have methods with the same name and
     different return types. If you do that Java will give you CTE.

        5) Variables in an interface are "public", "static" and "final".
        "public static final int price = 2300;" and "int price =2300;" are same

     6) Variables in interfaces are "static" default, therefore no need to create
     object to access variables in interfaces.
