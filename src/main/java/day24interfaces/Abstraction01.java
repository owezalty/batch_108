...
public abstract class Abstraction01 {
     ...
     * "final" keyword is very important in Java
     ...
     Note: "abstract classes" have something to do for child classes, if there is no
     child class, having "to-do list" is not sensible.
     "final classes" cannot have child classes, therefore Java does not
     allow to make an abstract class final.

     Note: "final method" body will be under protection by Java, because
     it should not be updated. But abstract methods don't have body,
     Java will look for the body to protect when it could not find it
     will complain
