...
public class E04 {
    ...
    public static void main(String[] args) {
        ...
        int r2 = convertStringToInt("abc");//NumberFormatException: If you use "valueOf()" method
        //with a String has non-digit character in it, you will have NumberFormatException
