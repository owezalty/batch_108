...
public class E01 {
    ...
    //1st Way: We do not recommend that way.
    //      i) It is not mandatory for developers to know all math rules.
    //      ii) In Math, there may be very problematic rules, it is so difficult to cover
    //      all in if statement
    ...
    //2nd Way: Handle Exception by using try-catch-block
