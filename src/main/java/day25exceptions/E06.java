...
public class E06 {
    ...
    public static void main(String[] args) {
        ...
        //doCombo(null, 2);//str.length(); will throw NullPointerException,
        //execution will be stopped in line 14
        //doCombo("12a", 2);//Integer.valueOf(str); will throw NumberFormatException

        //doCombo("420", 0);//intStr/num; will throw ArithmeticException,
        //execution will be stopped in line 24
    ...
    //Create a method i)Find the length of the String ii) Convert the String to an integer
    //iii)Divide the integer by a given number

    //A method will have multiple exceptions
