...
public class Teacher {
    ...
    /*
    1) If you create a method with the same name and different parameters, it means
    you are doing "Method Overloading".
    2)"Method Overloading" happens in a single class, therefore we do not need
    "inheritance" for "Method Overloading"
    3)To do "Method Overloading"
        i)Do not change the method name
        ii)Change the parameters by changing the a) number of the parameters
