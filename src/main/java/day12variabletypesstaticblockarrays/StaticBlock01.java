...
/*
1) If you do not assign any value for "static" and "non-static" variables,
Java assigns "default values" to them
but Java does not assign default value for "local variables."

2) Default values are "0" for numeric, "null" for String, false for boolean
...
public class StaticBlock01 {
    ...
    /*
     ...
     2) When the classes make ready, class members are loaded according to same order
        main method is the first one to be loaded normally.
     3) Sometimes we need something to be loaded before main method,
        for theis scenario we use "static block".
        The codes inside the "static block" is executed before everything in the class, even before main method.
     4) "static" structures can work just with static class members.
