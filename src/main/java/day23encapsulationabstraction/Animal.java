...
/*
    ...
    If you do not type the body of a method, you will have
    "method without body" (like angels),
    it is called "Abstract Method".

    2) "Concrete Methods" (Methods with body) focus on 2 things:
    i) What to do(Method)
    ii) How to do(Method body)
    "Abstract Methods" focus on just "What to do".

    3) If you make a method "abstract", it  will be mandatory to override
    for all child classes.

    4) "Abstract Methods" can be created just in "Abstract Classes"
    To make a Class abstract put "abstract" keyword between
    "access modifier" and "class" keyword.

    5) When you remove "method body" you have use "abstract" keyword
    between the "access modifier" and the "return type".
